...
(* OASIS_START *)
(* DO NOT EDIT (digest: 0177e456daefaecaff22e3b118611f61) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Gregory Tsipenyuk"; "Thomas Gazagnaire"];
          homepage = None;
          synopsis = "Regression tests for Irmin";
          description = None;
          categories = [];
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "overhead.ml"});
               Executable
                 ({
                     cs_name = "search";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "search.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "ûq[(\149\151\154\158Û7äÈ\017\016ü\025";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
